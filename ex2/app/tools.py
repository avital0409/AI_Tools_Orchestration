...
def calculateMath(expression: str) -> str:
    ...
    logger.info(f"Tool Execution: calculateMath(expression='{expression}')")
...
def getExchangeRate(currencyCode: str) -> str:
    ...
    logger.info(f"Tool Execution: getExchangeRate(currencyCode='{currencyCode}')")
    try:
...
def getWeather(city: str) -> str:
    ...
    logger.info(f"Tool Execution: getWeather(city='{city}')")
    city = city.strip()
